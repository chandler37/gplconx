...
void CClsPoint::initializeAnsweringMachines()
{
  if (ansMachs == NULL) {
    ...
    ST_CMETHOD(ansMachs, "random:", "instance creation", CLASS,
               ciAnswererRandom,
