...
# interface generated by SpecTcl version 1.1 from /home/davidc/Conx/gplconx.sourceforge/GPLconx/src/Tcl/tconxt.ui
...
proc tconxt_ui {root args} {
	...
	checkbutton $base.checkbutton#4 \
		-command {tconx_mother_check auto_update} \
		-text {Auto Update} \
		-underline 0 \
		-variable tconx_globls(auto_update_canvases)
	catch {
	...
	button $base.button#1 \
		-command "tconx_update_canvases_button_command $root" \
		-text {Update Canvases} \
		-underline 4
	catch {
	...
	grid $base.frame#7 -in $base.mainframe	-row 1 -column 1  \
		-sticky nesw
	grid $base.frame#8 -in $base.mainframe	-row 2 -column 1 
	...
	grid $base.scrollbar#1 -in $base.frame#7	-row 3 -column 2  \
		-sticky ew
	grid $base.checkbutton#4 -in $base.frame#8	-row 1 -column 1 
	grid $base.button#1 -in $base.frame#8	-row 1 -column 2 
	...
	grid rowconfigure $base.mainframe 2 -weight 0 -minsize 24
	...
	grid rowconfigure $root 2 -weight 1 -minsize 74
	grid rowconfigure $root 3 -weight 0 -minsize 7
	grid columnconfigure $root 1 -weight 1 -minsize 192

	grid rowconfigure $base.frame#8 1 -weight 0 -minsize 17
	grid columnconfigure $base.frame#8 1 -weight 0 -minsize 30
	grid columnconfigure $base.frame#8 2 -weight 0 -minsize 30

	grid rowconfigure $base.frame#5 1 -weight 0 -minsize 14
