/* Originally: togl.c,v 1.55 2000/05/12 00:28:12 thiessen Exp */

/*
 * Togl - a Tk OpenGL widget
 * Version 1.6
 * Copyright (C) 1996-2000  Brian Paul and Ben Bederson
 * See the LICENSE file for copyright details.
 */


/*
 * Currently we support X11 and WIN32 only
 */
...
#define TCL_ERR(interp, string) do { Tcl_ResetResult(interp); \
   ...
   if (togl->ShareContext && FindTogl(togl->ShareContext)) {
      ...
      visinfo = togl->VisInfo;
       ...
       if ((togl->aglCtx = aglCreateContext(fmt, shareCtx)) == NULL) {
          ...
          TCL_ERR(togl->Interp, "Togl: couldn't create context");
       }
       ...
       if (!aglSetDrawable(togl->aglCtx,
          ...
          TCL_ERR(togl->Interp, "Togl: couldn't set drawable");
       }
